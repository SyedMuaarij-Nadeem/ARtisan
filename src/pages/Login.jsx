  ...
  return (
    <div className="glass-card w-full p-5 sm:p-6">
      <div className="text-center mb-5 sm:mb-6">
        <h2 className="text-2xl sm:text-3xl font-brand mb-1">Welcome Back</h2>
        <p className="text-white/60 text-sm">Log in to continue to ARtisan</p>
      </div>
      ...
      <form className="space-y-4 sm:space-y-5" onSubmit={handleLogin}>
        ...
        <div className="flex justify-end mt-1">
          <Link to="/forgot-password" state={{ direction: 'swipe-left' }} className="text-xs text-accent hover:text-white transition-colors">
            Forgot Password?
          </Link>
        </div>

        <Button type="submit" className="py-2.5 mt-2" disabled={isLoading}>
